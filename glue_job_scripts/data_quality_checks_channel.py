...
additionalOptions={}
AmazonS3_node1725509619711_df = spark.read.format("delta").options(**additionalOptions).load("s3://youtube-analytics-data/etl_data/curated/curated_channel_data/")
...
EvaluateDataQuality_node1725509704977_ruleset = """
    ...
    Rules = [
        ...
        IsPrimaryKey "channel_id"
    ]
"""

EvaluateDataQuality_node1725509704977 = EvaluateDataQuality().process_rows(frame=AmazonS3_node1725509619711, ruleset=EvaluateDataQuality_node1725509704977_ruleset, publishing_options={"dataQualityEvaluationContext": "EvaluateDataQuality_node1725509704977", "enableDataQualityCloudWatchMetrics": True, "enableDataQualityResultsPublishing": True}, additional_options={"observations.scope":"ALL","performanceTuning.caching":"CACHE_NOTHING"})
...
# Script generated for node Amazon S3
AmazonS3_node1725510482040 = glueContext.write_dynamic_frame.from_options(frame=SelectFromCollection_node1725511978627, connection_type="s3", format="glueparquet", connection_options={"path": "s3://youtube-analytics-data/data_quality_results/channel_data/", "partitionKeys": ["updated_at"]}, format_options={"compression": "snappy"}, transformation_ctx="AmazonS3_node1725510482040")
